        ...
        <div class="header-container">
          ...
          <ul class="nav-right">
            <li class="notifications dropdown">
              <span class="counter bgc-red">3</span> <a href="#" class="dropdown-toggle no-after"
                  ...
                  <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                    <li>
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        <div class="peer mR-15"><img class="w-3r bdrs-50p" src="public/assets/images/1.jpg" alt=""></div>
                    ...
                    <li>
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        <div class="peer mR-15"><img class="w-3r bdrs-50p" src="public/assets/images/2.jpg" alt=""></div>
                        <div class="peer peer-greed">
                    ...
                    <li>
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        <div class="peer mR-15"><img class="w-3r bdrs-50p" src="public/assets/images/3.jpg" alt=""></div>
                        <div class="peer peer-greed">
            ...
            <li class="notifications dropdown">
              ...
              <ul class="dropdown-menu menu_dropown_1">
                      ...
                      <a href="#" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                        ...
                        <div class="peer peer-greed">
                          <div>
                            ...
                            <span class="c-grey-600 fsz-sm">Want to create your own customized data generator for your
                              app...</span>
                          </div>
                        </div>
                      </a>
                ...
                <li class="pX-20 pY-15 ta-c bdT"><span><a href="#" class="c-grey-600 cH-blue fsz-sm td-n">View All Email
                      <i class="fs-xs ti-angle-right mL-10"></i></a></span></li>
              </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                <div class="peer mR-10"><img class="w-2r bdrs-50p" src="public/assets/images/10.jpg" alt=""></div>

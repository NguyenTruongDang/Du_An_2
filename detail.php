...
<head>
	<base href="http://localhost:8080/freekok/">
	<meta charset="UTF-8">
	...
	<link rel="stylesheet" type="text/css" href="public/template/css/animate.min.css" <link rel="stylesheet" type="text/css" href="public/template/css/responsive.css">
								...
								<div class="comments-area">
									...
									<div class="comment-list">
										<div class="single-comment">
											<div class="user">
												<div class="thumb">
													<img src="public/template/img/member1.jpg" alt="">
												</div>
												<div class="desc">
									...
									<div class="comment-list left-padding">
										<div class="single-comment">
											<div class="user">
												<div class="thumb">
													<img src="public/template/img/member2.jpg" alt="">
												</div>
												<div class="desc">
									...
									<div class="comment-list left-padding">
										<div class="single-comment">
											<div class="user">
												<div class="thumb">
													<img src="public/template/img/member3.jpg" alt="">
												</div>
												<div class="desc">
									...
									<div class="comment-list">
										<div class="single-comment">
											<div class="user">
												<div class="thumb">
													<img src="public/template/img/member4.jpg" alt="">
												</div>
												<div class="desc">
									...
									<div class="comment-list">
										<div class="single-comment">
											<div class="user">
												<div class="thumb">
													<img src="public/template/img/member5.jpg" alt="">
												</div>
												<div class="desc">
